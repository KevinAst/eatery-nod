...
export default {
  ...
  mockGPS: true,  // should app mock GPS? ... regulates DeviceService.getCurPos():  real/mocked
                  // false: use real device location
                  // true:  mock device location (default to GlenCarbonIL)
                  // {lat, lng}: specify mocked location, example:
                  //             {lat: 40.48643,  lng: -86.1336}   ... Kokomo IN
                  //             {lat: 42.60559,  lng: -83.14993}  ... Troy MI
                  //             {lat: 38.752209, lng: -89.986610} ... GlenCarbon IL
